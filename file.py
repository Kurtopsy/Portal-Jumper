        ...
        if comment.is_root:
            if "!portaljump" in cbody and comment.author.name not in usernames:
                    ...
                    if my_option == "You Teleported to Jerryboree (1 Day Ban)":
                        ...
                        reddit.subreddit('rickandmorty').banned.add(comment.author.name, duration=1, ban_reason='Portal Jump', ban_message='Poor luck on the spin, but thanks for playing.', note='Portal Jump')
                        ...
                        reddit.subreddit('rickandmorty').banned.add(comment.author.name, duration=3, ban_reason='Portal Jump', ban_message='Poor luck on the spin, but thanks for playing.', note='Portal Jump')
                        ...
                        reddit.subreddit('rickandmorty').banned.add(comment.author.name, duration=7, ban_reason='Portal Jump', ban_message='Poor luck on the spin, but thanks for playing.', note='Portal Jump')
                        ...
                        reddit.subreddit('rickandmorty').banned.add(comment.author.name, duration=14, ban_reason='Portal Jump', ban_message='Poor luck on the spin, but thanks for playing.', note='Portal Jump')
                        ...
                        reddit.subreddit('rickandmorty').banned.add(comment.author.name, duration=30, ban_reason='Portal Jump', ban_message='Poor luck on the spin, but thanks for playing.', note='Portal Jump')
